...
const ABIPath = 'BOT/WEB3/MecKoinContractABI.json'
/**********************************************************************************/
...
async function transfer(fromAddress,privateKeyFrom,toAddress,tokenCount){
    ...
    return promise.then((hash) =>{ return hash },() =>{return false })
    // return promise.then(() =>{ return "Transaction was successful"},() =>{return "Transaction failed"})
}
